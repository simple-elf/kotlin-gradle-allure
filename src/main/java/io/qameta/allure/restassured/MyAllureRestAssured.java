 ...
 */
public class MyAllureRestAssured implements OrderedFilter {

    private String requestTemplatePath = "http-request.ftl";
    private String responseTemplatePath = "http-response.ftl";

    public MyAllureRestAssured setRequestTemplate(final String templatePath) {
        this.requestTemplatePath = templatePath;
        return this;
    }

    public MyAllureRestAssured setResponseTemplate(final String templatePath) {
    ...
    public Response filter(final FilterableRequestSpecification requestSpec,
        ...
        step("Request", () -> {
            if (Objects.nonNull(requestSpec.getBody())) {
                addAttachment("Request body", "application/json", prettifier.getPrettifiedBodyIfPossible(requestSpec), ".json");
            }
        ...
        step("Response", () -> {
            step("Response status: " + response.getStatusLine());
            addAttachment("Response body", "application/json", prettifier.getPrettifiedBodyIfPossible(response, response.getBody()), ".json");
